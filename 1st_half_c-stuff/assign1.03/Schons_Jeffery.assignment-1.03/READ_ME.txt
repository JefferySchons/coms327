...
TODO
	change pathfinding to just be counting up
	move the deciding waht char to place in print
		ex(if # is between 9 and whatever then add x to make pring cor char)