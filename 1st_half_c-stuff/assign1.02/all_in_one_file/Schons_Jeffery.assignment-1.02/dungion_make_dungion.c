...
int print_hardness_map(int dungion_hardness_map[map_x_size][map_y_size], int map_x_size, int map_y_size, int number_of_rooms);
...
int main(int argc, char *argv[]){
  ...
  for (i = 0; i < argc; i++) 
  {
	...
	//k=make_dungeon_map(dungion_map, dungion_hardness_map, room_array);
