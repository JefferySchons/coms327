...
int make_dungeon_map(char dungion_map_input[map_x_size][map_y_size], int dungion_hardness_map_input[map_x_size][map_y_size], room room_array_input[number_of_rooms],  int map_x_size, int map_y_size, int number_of_rooms);
int print_map(char dungion_map[map_x_size][map_y_size], int map_x_size, int map_y_size, int number_of_rooms, char monster_map_input[map_x_size][map_y_size]);
...
int save_dungion(char dungion_map_input[map_x_size][map_y_size], int dungion_hardness_map_input[map_x_size][map_y_size], room room_array_input[number_of_rooms],  int map_x_size, int map_y_size, int number_of_rooms);
int load_dungion(char dungion_map_input[map_x_size][map_y_size], int dungion_hardness_map_input[map_x_size][map_y_size], room room_array_input[number_of_rooms],  int map_x_size, int map_y_size, int number_of_rooms);
...
int place_monsters(char monster_map_input[map_x_size][map_y_size], char dungion_map_input[map_x_size][map_y_size], room room_array_input[number_of_rooms], int map_x_size, int map_y_size, int number_of_rooms, int num_monsters, creature creature_array[num_monsters]);
int run_game(char monster_map_input[map_x_size][map_y_size], char dungion_map_input[map_x_size][map_y_size], int dungion_hardness_map_input[map_x_size][map_y_size], char pathfinding_map_input[map_x_size][map_y_size], room room_array_input[number_of_rooms], int map_x_size, int map_y_size, int number_of_rooms, int num_monsters, creature creature_array[num_monsters], int line_of_sight_map_input[map_x_size][map_y_size]);

int line_of_sight(char dungion_map_input[map_x_size][map_y_size], int dungion_hardness_map_input[map_x_size][map_y_size], int line_of_sight_map_input[map_x_size][map_y_size], int map_x_size, int map_y_size, int pc_x, int pc_y);
...
int main(int argc, char *argv[]){
	...
	int line_of_sight_map[map_x_size][map_y_size];
	
	//only used to display monster token
	//reset after every move
	char monster_map[map_x_size][map_y_size];
...
int save_dungion(char dungion_map_input[map_x_size][map_y_size], int dungion_hardness_map_input[map_x_size][map_y_size], room room_array_input[6],  int map_x_size, int map_y_size, int number_of_rooms)
{
...
int place_monsters(char monster_map_input[map_x_size][map_y_size], char dungion_map_input[map_x_size][map_y_size], room room_array_input[number_of_rooms], int map_x_size, int map_y_size, int number_of_rooms, int num_monsters, struct creature creature_array[num_monsters])
{
...
int run_game(char monster_map_input[map_x_size][map_y_size], char dungion_map_input[map_x_size][map_y_size], int dungion_hardness_map_input[map_x_size][map_y_size], char pathfinding_map_input[map_x_size][map_y_size], room room_array_input[number_of_rooms], int map_x_size, int map_y_size, int number_of_rooms, int num_monsters, creature creature_array[num_monsters], int line_of_sight_map_input[map_x_size][map_y_size])
{
	...
	char object_map[map_x_size][map_y_size];
	//make object array
	struct object object_list[15];
	char fow_map[map_x_size][map_y_size];//for the fog of war map done in c++
	for(j=0; j<map_y_size; j++)
	{
		for(k=0; k<map_x_size; k++)
		{
